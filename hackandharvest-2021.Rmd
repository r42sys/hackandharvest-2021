...
**Anzahl der Bäume im Kataster der Stadt Konstanz**
```{r}
nrow(kataster)
```
...
kataster %>%
    ...
    ggplot() +
        ...
        labs(title='Bäume der Stadt Konstanz (Gattungen)', x='Gattung', y='Anzahl Bäume') +
        theme_bw() +
...
**Anzahl der Gattungen der Bäume der Stadt Konstanz**
```{r}
length(unique(kataster[!is.na(kataster$gattung),'gattung']))
```

Anzahl der Bäume der Stadt Konstanz ohne einen gültigen Wert für die Gattung
```{r}
...
**Anzahl der Arten Bäume der Stadt Konstanz**
```{r}
length(unique(kataster[!is.na(kataster$name_de),'name_de']))
```

Anzahl der Bäume der Stadt Konstanz ohne einen gültigen Wert für die Art
```{r}
...
Anzahl der Bäume der Stadt Konstanz ohne einen gültigen Wert für den Stammumfang
```{r}
...
Anzahl der Bäume der STadt Konstanz ohne einen gültigen Wert für die Höhe
```{r}
...
Anzahl der Bäume der Stadt Konstanz ohne einen gültigen Wert für den Kronendurchmesser
```{r}
...
Anzahl der Bäume der Stadt Konstanz ohne einen gültigen Wert für den Standort
```{r}
...
**O<sub>2</sub>-Produktion der Bäume der Stadt Konstanz in Tonnen pro Jahr**
```{r}
...
**CO<sub>2</sub>-Aufnahme der Bäume der Stadt Konstanz in Tonnen pro Jahr**
```{r}
