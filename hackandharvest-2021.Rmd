...
```
**Abbildung** Gattung der Bäume der Stadt Konstanz für Gattungen mit mehr als `r N` Bäumen.
...
```
**Tabelle** Gattung der Bäume der Stadt Konstanz sortiert nach Anzahl der Bäume.


Das Baumkataster der Stadt Konstanzer enthält `r length(unique(kataster[!is.na(kataster$gattung),'gattung']))` verschiedene Gattungen - `r nrow(kataster[is.na(kataster$gattung),])` Einträge haben hier keinen gültigen Wert.
